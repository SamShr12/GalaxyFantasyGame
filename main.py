...
class MainWidget(RelativeLayout):
    ...
    from userActions import keyboard_closed, on_keyboard_up, on_keyboard_down, on_touch_down, on_touch_up
    ...
    #menuname
    menu_title = StringProperty("D A W N : R U N A W A Y")
    menu_button_title = StringProperty("START")
    #score
    score_in = StringProperty()
    #soundvalue
    sound_start = None
    sound_galaxy = None
    ...
    def reset_game(self):
        ...
        self.score_in = 'SCORE: ' + str(self.current_y_loop)
    ...
    def update_ship(self):
        ...
        x1, y1 = self.transform(*self.ship_coordinates[0])  # '*' is going to insert the given argruments
    ...
    def generate_tiles_coordinates(self):
        #remove the tiles who went beyond the screen
        #tile index_y < current_y_loop
        last_x = 0
        last_y = 0

        for i in range(len(self.tiles_coordinates)-1, -1, -1):
            if self.tiles_coordinates[i][1] < self.current_y_loop:
                del self.tiles_coordinates[i] # delete tile that went out
    ...
    def get_tile_coordinate(self, ti_x, ti_y):
        ti_y = ti_y - self.current_y_loop # index -1, making tile on below index
    ...
    def update_vertical_lines(self):
        ...
        # if there are 4 lines index is -1,0,1,2
        start_index = -int(self.V_NB_LINES/2)+1
